...
export class ProfileComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.placesService.getRegions('Tanzania').subscribe(regions => {
      this.states = regions;
  ...
  addressChange(e) {
    if (e.target.id === 'state') {
      ...
      this.placesService.getCities(this.selectedState, 'Tanzania').subscribe(cities => {
        this.cities = cities;
      });
      ...
      this.placesService.getCounties(this.selectedState, this.selectedCity, 'Tanzania').subscribe(counties => {
        this.counties = counties;
      });
    } else if (e.target.id === 'county') {
      this.profileForm.get('address').get('street').setValue(null);
      this.selectedCounty = e.target.value;
      this.placesService.getStreets(this.selectedState, this.selectedCity, this.selectedCounty, 'Tanzania').subscribe(streets => {
        this.streets = streets;
      });
